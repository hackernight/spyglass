...
BASE_URL = "http://api.acoustid.org/v2/"
LOOKUP_PATH = "lookup"
PATH_SEPERATOR = "/"

class AcoustID(object):
	"""AcoustID is a wrapper class around the api for acoutid."""
	def __init__(self):
		super(AcoustID, self).__init__()
		self.token = "Uk5CwoXo"
